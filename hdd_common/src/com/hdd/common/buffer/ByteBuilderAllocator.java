...
/**
 * Allocates {@link ByteBuilder}s and manages them.  Please implement this
 * interface if you need more advanced memory management scheme.
 *
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
public interface ByteBuilderAllocator {
    /**
     ...
     */
    ByteBuilder allocate(int capacity, boolean direct);
     ...
     */
    ByteBuilder wrap(ByteBuffer nioBuffer);
