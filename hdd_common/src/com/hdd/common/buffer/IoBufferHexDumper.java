...
/**
 * Provides utility methods to dump an {@link ByteBuilder} into a hex formatted string.
 *
...
class IoBufferHexDumper {
    ...
    /**
     * Dumps an {@link ByteBuilder} to a hex formatted string.
     * 
     ...
     */
    public static String getHexdump(ByteBuilder in, int lengthLimit) {
        if (lengthLimit == 0) {
