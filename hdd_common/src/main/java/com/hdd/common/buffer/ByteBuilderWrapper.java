...
/**
 * A {@link ByteBuilder} that wraps a buffer and proxies any operations to it.
 * <p>
 ...
 */
public class ByteBuilderWrapper extends ByteBuilder {

    /**
     * The buffer proxied by this proxy.
     */
    private final ByteBuilder buf;

    /**
     * Create a new instance.
     * @param buf the buffer to be proxied
     */
    protected ByteBuilderWrapper(ByteBuilder buf) {
        if (buf == null) {
     ...
     */
    public ByteBuilder getParentBuffer() {
        return buf;
    }
    ...
    @Override
    public ByteBuilder position(int newPosition) {
    ...
    @Override
    public ByteBuilder limit(int newLimit) {
        buf.limit(newLimit);
        return this;
    }

    @Override
    public ByteBuilder mark() {
        buf.mark();
        return this;
    }

    @Override
    public ByteBuilder reset() {
        buf.reset();
        return this;
    }
    ...
    @Override
    public ByteBuilder sweep() {
        buf.sweep();
        return this;
    }

    @Override
    public ByteBuilder sweep(byte value) {
        buf.sweep(value);
        return this;
    }

    @Override
    public ByteBuilder flip() {
        buf.flip();
        return this;
    }

    @Override
    public ByteBuilder rewind() {
        buf.rewind();
        return this;
    }
    ...
    @Override
    public ByteBuilder put(int index, byte b) {
        buf.put(index, b);
        return this;
    }

    @Override
    public ByteBuilder get(byte[] dst, int offset, int length) {
        buf.get(dst, offset, length);
        return this;
    }

    @Override
    public ByteBuilder getSlice(int index, int length) {
        return buf.getSlice(index, length);
    }

    @Override
    public ByteBuilder getSlice(int length) {
    ...
    @Override
    public ByteBuilder put(ByteBuffer src) {
        buf.put(src);
        return this;
    }

    @Override
    public ByteBuilder put(byte[] src, int offset, int length) {
    ...
    @Override
    public ByteBuilder order(ByteOrder bo) {
        buf.order(bo);
        return this;
    }
    ...
    @Override
    public ByteBuilder putChar(char value) {
        buf.putChar(value);
        return this;
    }
    ...
    @Override
    public ByteBuilder putChar(int index, char value) {
    ...
    @Override
    public ByteBuilder putShort(short value) {
        buf.putShort(value);
        return this;
    }
    ...
    @Override
    public ByteBuilder putShort(int index, short value) {
    ...
    @Override
    public ByteBuilder putInt(int value) {
        buf.putInt(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(byte value) {
        buf.putUnsignedInt(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(int index, byte value) {
        buf.putUnsignedInt(index, value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(short value) {
        buf.putUnsignedInt(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(int index, short value) {
        buf.putUnsignedInt(index, value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(int value) {
        buf.putUnsignedInt(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(int index, int value) {
        buf.putUnsignedInt(index, value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(long value) {
        buf.putUnsignedInt(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedInt(int index, long value) {
        buf.putUnsignedInt(index, value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(byte value) {
        buf.putUnsignedShort(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(int index, byte value) {
        buf.putUnsignedShort(index, value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(short value) {
        buf.putUnsignedShort(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(int index, short value) {
        buf.putUnsignedShort(index, value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(int value) {
        buf.putUnsignedShort(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(int index, int value) {
        buf.putUnsignedShort(index, value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(long value) {
        buf.putUnsignedShort(value);
        return this;
    }

    @Override
    public ByteBuilder putUnsignedShort(int index, long value) {
        buf.putUnsignedShort(index, value);
        return this;
    }
    ...
    @Override
    public ByteBuilder putInt(int index, int value) {
    ...
    @Override
    public ByteBuilder putLong(long value) {
        buf.putLong(value);
        return this;
    }
    ...
    @Override
    public ByteBuilder putLong(int index, long value) {
    ...
    @Override
    public ByteBuilder putFloat(float value) {
        buf.putFloat(value);
        return this;
    }
    ...
    @Override
    public ByteBuilder putFloat(int index, float value) {
    ...
    @Override
    public ByteBuilder putDouble(double value) {
        buf.putDouble(value);
        return this;
    }
    ...
    @Override
    public ByteBuilder putDouble(int index, double value) {
    ...
    @Override
    public ByteBuilder putString(CharSequence in, int fieldSize, CharsetEncoder encoder) throws CharacterCodingException {
        buf.putString(in, fieldSize, encoder);
        return this;
    }

    @Override
    public ByteBuilder putString(CharSequence in, CharsetEncoder encoder) throws CharacterCodingException {
    ...
    @Override
    public ByteBuilder putPrefixedString(CharSequence in, int prefixLength, int padding, byte padValue,
    ...
    @Override
    public ByteBuilder setAutoExpand(boolean autoExpand) {
        buf.setAutoExpand(autoExpand);
        return this;
    }

    @Override
    public ByteBuilder expand(int pos, int expectedRemaining) {
        buf.expand(pos, expectedRemaining);
        return this;
    }

    @Override
    public ByteBuilder expand(int expectedRemaining) {
    ...
    @Override
    public ByteBuilder duplicate() {
        return buf.duplicate();
    }

    @Override
    public ByteBuilder slice() {
        return buf.slice();
    }

    @Override
    public ByteBuilder asReadOnlyBuffer() {
    ...
    @Override
    public ByteBuilder minimumCapacity(int minimumCapacity) {
        buf.minimumCapacity(minimumCapacity);
        return this;
    }

    @Override
    public ByteBuilder capacity(int newCapacity) {
    ...
    @Override
    public ByteBuilder setAutoShrink(boolean autoShrink) {
        buf.setAutoShrink(autoShrink);
        return this;
    }

    @Override
    public ByteBuilder shrink() {
        buf.shrink();
        return this;
    }
