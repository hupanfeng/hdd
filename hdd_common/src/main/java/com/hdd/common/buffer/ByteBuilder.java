...
/**
 * A byte buffer used by applications.
 * <p>
 * This is a replacement for {@link ByteBuffer}. Please refer to
 * {@link ByteBuffer} documentation for preliminary usage. does not use NIO
 ...
 * easy, and it is because its size is fixed. {@link ByteBuilder} introduces
 ...
 * </pre>
 * 
 * The underlying {@link ByteBuffer} is reallocated by {@link ByteBuilder}
 * behind the scene if the encoded data is larger than 16 bytes in the example
 * above. Its capacity will double, and its limit will increase to the last
 * position the string is written.
 * </p>
 * 
 * <h2>AutoShrink</h2>
 * <p>
 * You might also want to decrease the capacity of the buffer when most of the
 * allocated memory area is not being used. {@link ByteBuilder} provides
 * <tt>autoShrink</tt> property to take care of this issue. If
 * <tt>autoShrink</tt> is turned on, {@link ByteBuilder} halves the capacity of
 * the buffer when {@link #compact()} is invoked and only 1/4 or less of the
 ...
 * <p>
 * {@link ByteBuilderAllocator} interface lets you override the default buffer
 * management behavior. There are two allocators provided out-of-the-box:
 * <ul>
 * <li>{@link SimpleByteBuilderAllocator} (default)</li>
 * <li>{@link CachedByteBuilderAllocator}</li>
 * </ul>
 * You can implement your own allocator and use it by calling
 * {@link #setAllocator(ByteBuilderAllocator)}.
 * </p>
 * 
 */
public abstract class ByteBuilder implements Comparable<ByteBuilder> {
    /** The allocator used to create new buffers */
    private static ByteBuilderAllocator allocator = new SimpleByteBuilderAllocator();
     ...
     */
    public static ByteBuilderAllocator getAllocator() {
        return allocator;
    }
     ...
     */
    public static void setAllocator(ByteBuilderAllocator newAllocator) {
        if (newAllocator == null) {
            throw new IllegalArgumentException("allocator");
        }

        ByteBuilderAllocator oldAllocator = allocator;
    ...
    public static void setUseDirectBuffer(boolean useDirectBuffer) {
        ByteBuilder.useDirectBuffer = useDirectBuffer;
    }
     ...
     */
    public static ByteBuilder allocate(int capacity) {
     ...
     *            heap buffer.
     */
    public static ByteBuilder allocate(int capacity, boolean direct) {
        if (capacity < 0) {
    ...
    /**
     * Wraps the specified NIO {@link ByteBuffer} into buffer.
     */
    public static ByteBuilder wrap(ByteBuffer nioBuffer) {
        return allocator.wrap(nioBuffer);
    }

    /**
     * Wraps the specified byte array into heap buffer.
     */
    public static ByteBuilder wrap(byte[] byteArray) {
     ...
     * Wraps the specified byte array into heap buffer.
     */
    public static ByteBuilder wrap(byte[] byteArray, int offset, int length) {
     ...
     */
    protected ByteBuilder() {
        // Do nothing
    }

    /**
     * Declares this buffer and all its derived buffers are not used anymore so
     * that it can be reused by some {@link ByteBuilderAllocator}
     * implementations. It is not mandatory to call this method, but you might
     * want to invoke this method for maximum performance.
     */
     ...
     * the buffer.
     */
    public abstract ByteBuilder minimumCapacity(int minimumCapacity);
     ...
     * the buffer.
     */
    public abstract ByteBuilder capacity(int newCapacity);
     ...
     */
    public abstract ByteBuilder setAutoExpand(boolean autoExpand);
     ...
     */
    public abstract ByteBuilder setAutoShrink(boolean autoShrink);
     ...
     */
    public abstract ByteBuilder expand(int expectedRemaining);
     ...
     */
    public abstract ByteBuilder expand(int position, int expectedRemaining);
     ...
     */
    public abstract ByteBuilder shrink();
     ...
     */
    public abstract ByteBuilder position(int newPosition);
     ...
     */
    public abstract ByteBuilder limit(int newLimit);

    /**
     * @see java.nio.Buffer#mark()
     */
    public abstract ByteBuilder mark();
     ...
     */
    public abstract ByteBuilder reset();

    /**
     * @see java.nio.Buffer#clear()
     */
    public abstract ByteBuilder clear();
     ...
     * discarded.
     */
    public abstract ByteBuilder sweep();
     ...
     * is discarded.
     */
    public abstract ByteBuilder sweep(byte value);

    /**
     * @see java.nio.Buffer#flip()
     */
    public abstract ByteBuilder flip();

    /**
     * @see java.nio.Buffer#rewind()
     */
    public abstract ByteBuilder rewind();
     ...
     */
    public abstract ByteBuilder duplicate();

    /**
     * @see ByteBuffer#slice()
     */
    public abstract ByteBuilder slice();

    /**
     * @see ByteBuffer#asReadOnlyBuffer()
     */
    public abstract ByteBuilder asReadOnlyBuffer();
     ...
     */
    public abstract ByteBuilder put(byte b);
     ...
     */
    public abstract ByteBuilder put(int index, byte b);

    /**
     * @see ByteBuffer#get(byte[], int, int)
     */
    public abstract ByteBuilder get(byte[] dst, int offset, int length);

    /**
     * @see ByteBuffer#get(byte[])
     */
    public abstract ByteBuilder get(byte[] dst);

    /**
     * TODO document me.
     */
    public abstract ByteBuilder getSlice(int index, int length);

    /**
     * TODO document me.
     */
    public abstract ByteBuilder getSlice(int length);

    /**
     * Writes the content of the specified <tt>src</tt> into this buffer.
     */
    public abstract ByteBuilder put(ByteBuffer src);

    /**
     * Writes the content of the specified <tt>src</tt> into this buffer.
     */
    public abstract ByteBuilder put(ByteBuilder src);

    /**
     * @see ByteBuffer#put(byte[], int, int)
     */
    public abstract ByteBuilder put(byte[] src, int offset, int length);

    /**
     * @see ByteBuffer#put(byte[])
     */
    public abstract ByteBuilder put(byte[] src);

    /**
     * @see ByteBuffer#compact()
     */
    public abstract ByteBuilder compact();
     ...
     */
    public abstract ByteBuilder order(ByteOrder bo);
     ...
     */
    public abstract ByteBuilder putChar(char value);
     ...
     */
    public abstract ByteBuilder putChar(int index, char value);
     ...
     */
    public abstract ByteBuilder putShort(short value);
     ...
     */
    public abstract ByteBuilder putShort(int index, short value);
     ...
     */
    public abstract ByteBuilder putMediumInt(int value);
     ...
     *             If this buffer is read-only
     */
    public abstract ByteBuilder putMediumInt(int index, int value);

    /**
     * @see ByteBuffer#putInt(int)
     */
    public abstract ByteBuilder putInt(int value);
     ...
     *            the byte to write
     */
    public abstract ByteBuilder putUnsigned(byte value);
     ...
     *            the byte to write
     */
    public abstract ByteBuilder putUnsigned(int index, byte value);
     ...
     *            the short to write
     */
    public abstract ByteBuilder putUnsigned(short value);
     ...
     *            the short to write
     */
    public abstract ByteBuilder putUnsigned(int index, short value);
     ...
     *            the int to write
     */
    public abstract ByteBuilder putUnsigned(int value);
     ...
     *            the int to write
     */
    public abstract ByteBuilder putUnsigned(int index, int value);
     ...
     *            the long to write
     */
    public abstract ByteBuilder putUnsigned(long value);
     ...
     *            the long to write
     */
    public abstract ByteBuilder putUnsigned(int index, long value);
     ...
     *            the byte to write
     */
    public abstract ByteBuilder putUnsignedInt(byte value);
     ...
     *            the byte to write
     */
    public abstract ByteBuilder putUnsignedInt(int index, byte value);
     ...
     *            the short to write
     */
    public abstract ByteBuilder putUnsignedInt(short value);
     ...
     *            the short to write
     */
    public abstract ByteBuilder putUnsignedInt(int index, short value);
     ...
     *            the int to write
     */
    public abstract ByteBuilder putUnsignedInt(int value);
     ...
     *            the int to write
     */
    public abstract ByteBuilder putUnsignedInt(int index, int value);
     ...
     *            the long to write
     */
    public abstract ByteBuilder putUnsignedInt(long value);
     ...
     *            the long to write
     */
    public abstract ByteBuilder putUnsignedInt(int index, long value);
     ...
     *            the byte to write
     */
    public abstract ByteBuilder putUnsignedShort(byte value);
     ...
     *            the byte to write
     */
    public abstract ByteBuilder putUnsignedShort(int index, byte value);
     ...
     *            the short to write
     */
    public abstract ByteBuilder putUnsignedShort(short value);
     ...
     *            the short to write
     */
    public abstract ByteBuilder putUnsignedShort(int index, short value);
     ...
     *            the int to write
     */
    public abstract ByteBuilder putUnsignedShort(int value);
     ...
     *            the int to write
     */
    public abstract ByteBuilder putUnsignedShort(int index, int value);
     ...
     *            the long to write
     */
    public abstract ByteBuilder putUnsignedShort(long value);
     ...
     *            the long to write
     */
    public abstract ByteBuilder putUnsignedShort(int index, long value);
     ...
     */
    public abstract ByteBuilder putInt(int index, int value);
     ...
     */
    public abstract ByteBuilder putLong(long value);
     ...
     * @see ByteBuffer#putLong(int, long)
     */
    public abstract ByteBuilder putLong(int index, long value);
     ...
     */
    public abstract ByteBuilder putFloat(float value);
     ...
     */
    public abstract ByteBuilder putFloat(int index, float value);
     ...
     */
    public abstract ByteBuilder putDouble(double value);
     ...
     */
    public abstract ByteBuilder putDouble(int index, double value);
     ...
     */
    public abstract ByteBuilder putString(CharSequence val, CharsetEncoder encoder) throws CharacterCodingException;
     ...
     */
    public abstract ByteBuilder putString(CharSequence val, int fieldSize, CharsetEncoder encoder)
     ...
     *             if the specified string doesn't fit
     */
    public abstract ByteBuilder putPrefixedString(CharSequence in, CharsetEncoder encoder)
            throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract ByteBuilder putPrefixedString(CharSequence in, int prefixLength, CharsetEncoder encoder)
            throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract ByteBuilder putPrefixedString(CharSequence in, int prefixLength, int padding, CharsetEncoder encoder)
            throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract ByteBuilder putPrefixedString(CharSequence val, int prefixLength, int padding, byte padValue,
     ...
     */
    public abstract ByteBuilder putObject(Object o);
     ...
     */
    public abstract ByteBuilder putEnum(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract ByteBuilder putEnum(int index, Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract ByteBuilder putEnumShort(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract ByteBuilder putEnumShort(int index, Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract ByteBuilder putEnumInt(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract ByteBuilder putEnumInt(int index, Enum<?> e);
     ...
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSet(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSet(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSetShort(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSetShort(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSetInt(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSetInt(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSetLong(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> ByteBuilder putEnumSetLong(int index, Set<E> set);
}
